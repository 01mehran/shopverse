      ...
      <Container>
        ...
        >
          {commentList.map((comment, i) => (
            <article
              key={i}
              className="xs:min-w-100 flex h-50 min-w-full snap-start flex-col items-start justify-center gap-4 rounded-2xl border border-black/10 p-4 shadow-lg md:p-7 lg:min-w-1/3"
            >
